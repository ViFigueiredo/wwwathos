...
function TermsOfUse() {
  return (
    <LegalPage title="Termos de Uso">
      <h2>1. Termos</h2>
      <p>
        Ao acessar ao site <Link to="/">Conexão CO</Link>, concorda em cumprir estes
      ...
      <p>
        ...
        (informações ou software) no site Conexão CO, apenas para visualização
      ...
      <p>
        ...
        restrições e poderá ser rescindida por Conexão CO a qualquer momento. Ao
      ...
      <ol>
        <li>
          Os materiais no site da Conexão CO são fornecidos 'como estão'. Conexão CO
        ...
        <li>
          Também o Conexão CO não garante ou faz qualquer representação relativa à
      ...
      <h2>4. Limitações</h2>
      <p>
        Em nenhum caso o Conexão CO ou seus fornecedores serão responsáveis por
        ...
        incapacidade de usar os materiais em Conexão CO, mesmo que Conexão CO ou um
        representante autorizado da Conexão CO tenha sido notificado oralmente ou
      ...
      <p>
        Os materiais exibidos no site da Conexão CO podem incluir erros técnicos,
        tipográficos ou fotográficos. Conexão CO não garante que qualquer material
        em seu site seja preciso, completo ou atual. Conexão CO pode fazer
        alterações nos materiais contidos em seu site a qualquer momento, sem aviso
        prévio. No entanto, Conexão CO não se compromete a atualizar os materiais.
      </p>

      <h2>6. Links</h2>
      <p>
        O Conexão CO não analisou todos os sites vinculados ao seu site e não é
        responsável pelo conteúdo de nenhum site vinculado. A inclusão de qualquer
        link não implica endosso por Conexão CO do site. O uso de qualquer site
        vinculado é por conta e risco do usuário.
      </p>

      <h2>Modificações</h2>
      <p>
        O Conexão CO pode revisar estes termos de serviço do site a qualquer
      ...
      <p>
        ...
        do Conexão CO e você se submete irrevogavelmente à jurisdição exclusiva dos
