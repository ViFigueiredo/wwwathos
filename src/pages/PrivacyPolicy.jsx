...
function PrivacyPolicy() {
  return (
    <LegalPage title="Política de Privacidade">
      <p>
        A sua privacidade é importante para nós. É política do Conexão CO respeitar
        a sua privacidade em relação a qualquer informação sua que possamos coletar
        no site <Link to="/">Conexão CO</Link>, e outros sites que possuímos e
        operamos.
      </p>
      <p>
        Solicitamos informações pessoais apenas quando precisamos delas para lhe
      ...
      <p>
        ...
        entendendo que não possamos fornecer alguns dos serviços desejados.
      </p>
      <p>
      ...
      <ul>
        <li>
          ...
          cookie DoubleClick para veicular anúncios mais relevantes em toda a Web e
          limitar o número de vezes que um determinado anúncio é exibido para você.
        </li>
        <li>
        ...
        <li>
          ...
          afiliados nos permitem ver se nossos clientes acessaram o site através de
          um dos sites de nossos parceiros, para que possamos creditá-los
          adequadamente e, quando aplicável, permitir que nossos parceiros
          afiliados ofereçam qualquer promoção que pode fornecê-lo para fazer uma
          compra.
        </li>
      </ul>
      ...
      <p>
        ...
        que o Conexão CO oferece no site e com caráter enunciativo, mas não
        limitativo:
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          (softwares) do Conexão CO, de seus fornecedores ou terceiros, para
